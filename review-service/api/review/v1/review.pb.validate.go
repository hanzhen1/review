...
// Validate checks the field values on GetReplyReviewRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetReplyReviewRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetReplyReviewRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetReplyReviewRequestMultiError, or nil if none found.
func (m *GetReplyReviewRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *GetReplyReviewRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if m.GetReviewID() <= 0 {
		err := GetReplyReviewRequestValidationError{
			field:  "ReviewID",
			reason: "value must be greater than 0",
		}
		if !all {
	...
	if len(errors) > 0 {
		return GetReplyReviewRequestMultiError(errors)
	}

	return nil
}

// GetReplyReviewRequestMultiError is an error wrapping multiple validation
// errors returned by GetReplyReviewRequest.ValidateAll() if the designated
// constraints aren't met.
type GetReplyReviewRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetReplyReviewRequestMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetReplyReviewRequestMultiError) AllErrors() []error { return m }

// GetReplyReviewRequestValidationError is the validation error returned by
// GetReplyReviewRequest.Validate if the designated constraints aren't met.
type GetReplyReviewRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetReplyReviewRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetReplyReviewRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetReplyReviewRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetReplyReviewRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetReplyReviewRequestValidationError) ErrorName() string {
	return "GetReplyReviewRequestValidationError"
}

// Error satisfies the builtin error interface
func (e GetReplyReviewRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetReplyReviewRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetReplyReviewRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetReplyReviewRequestValidationError{}

// Validate checks the field values on GetReplyReviewReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *GetReplyReviewReply) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on GetReplyReviewReply with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// GetReplyReviewReplyMultiError, or nil if none found.
func (m *GetReplyReviewReply) ValidateAll() error {
	return m.validate(true)
}

func (m *GetReplyReviewReply) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, GetReplyReviewReplyValidationError{
					field:  "Data",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return GetReplyReviewReplyValidationError{
				field:  "Data",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return GetReplyReviewReplyMultiError(errors)
	}

	return nil
}

// GetReplyReviewReplyMultiError is an error wrapping multiple validation
// errors returned by GetReplyReviewReply.ValidateAll() if the designated
// constraints aren't met.
type GetReplyReviewReplyMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m GetReplyReviewReplyMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m GetReplyReviewReplyMultiError) AllErrors() []error { return m }

// GetReplyReviewReplyValidationError is the validation error returned by
// GetReplyReviewReply.Validate if the designated constraints aren't met.
type GetReplyReviewReplyValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e GetReplyReviewReplyValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e GetReplyReviewReplyValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e GetReplyReviewReplyValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e GetReplyReviewReplyValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e GetReplyReviewReplyValidationError) ErrorName() string {
	return "GetReplyReviewReplyValidationError"
}

// Error satisfies the builtin error interface
func (e GetReplyReviewReplyValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sGetReplyReviewReply.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = GetReplyReviewReplyValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = GetReplyReviewReplyValidationError{}
