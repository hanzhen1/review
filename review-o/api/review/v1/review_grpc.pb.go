...
const (
	...
	Review_GetReplyReview_FullMethodName      = "/api.review.v1.Review/GetReplyReview"
...
type ReviewClient interface {
	...
	// 获取评价回复
	GetReplyReview(ctx context.Context, in *GetReplyReviewRequest, opts ...grpc.CallOption) (*GetReplyReviewReply, error)
	// B端申诉评价
...
func (c *reviewClient) GetReplyReview(ctx context.Context, in *GetReplyReviewRequest, opts ...grpc.CallOption) (*GetReplyReviewReply, error) {
	out := new(GetReplyReviewReply)
	err := c.cc.Invoke(ctx, Review_GetReplyReview_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReviewServer) GetReplyReview(context.Context, *GetReplyReviewRequest) (*GetReplyReviewReply, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetReplyReview not implemented")
}
...
func _Review_GetReplyReview_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetReplyReviewRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReviewServer).GetReplyReview(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Review_GetReplyReview_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServer).GetReplyReview(ctx, req.(*GetReplyReviewRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Review_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetReplyReview",
			Handler:    _Review_GetReplyReview_Handler,
		},
		{
